...
class AgentB:
    def __init__(self):
        ...
        self.personalities = ["organic consumer", "fast food lover", "vegan", 
                         "meateater", "picky eater", "michelin food",
                         "foodie", "home cook", "street food enthusiast",
                         "budget eater", "gourmet", "health conscious eater"]

        self.food_style = ["loves creative and exotic dishes", "prefers simple and familiar foods",
    ...
    def respond_to_question(self, question):
        ...
        role = (
            f"You are a {random.choice(self.personalities)} diner that {random.choice(self.food_style)}. "
